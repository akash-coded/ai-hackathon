              ...
              >
                <Sparkles
                  className={`w-5 h-5 mt-0.5 ${
                    insights.meta.source === 'gemini' ? 'text-blue-600' : 'text-purple-600'
                  }`}
                />
                <div>
                  <p className="text-sm font-semibold text-gray-900">
                    {insights.meta.source === 'gemini' ? 'Live generative analysis' : 'Smart offline insights'}
                  </p>
                  {insights.meta.note && <p className="text-sm text-gray-600 mt-1">{insights.meta.note}</p>}
                </div>
              </div>
            )}
